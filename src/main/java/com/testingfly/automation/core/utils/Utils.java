...
import com.testingfly.automation.alm.Client;
import com.testingfly.automation.alm.XmlParser;
...
import com.testingfly.automation.core.data.IConfigurer;
import com.testingfly.automation.core.data.TextConfigurer;
...
//		pdfFileName = "API_Test_Result_"+Config.getProp("Environment")+"_"+Config.getProp("tagName")+"_"+ts+".pdf";
	...
	public static void htmlToXls(String file) {
	    ...
	    public static void updateReqALM() throws Exception{
	    	...
	    	Client client = new Client(new com.testingfly.automation.alm.Config("alm.properties"));
	    	client.login();

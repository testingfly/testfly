package com.testingfly.automation.core.table;
...
public class Table {
	...
	public void setColumns(Record record){
		columns.addAll(record.getColumns());//new TreeSet<String>();
...
//		}
	...
	public Table getRecords(Map<String, String> conditions){
		List<Record> records = getRecords(conditions.keySet().toArray(new String[conditions.size()]), conditions.values().toArray(new String[conditions.size()]));
		Table t = new Table();
...
//	public void appendColumns(Record r){

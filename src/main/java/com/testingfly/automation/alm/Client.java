package com.testingfly.automation.alm;
...
import com.testingfly.automation.alm.model.*;
...
//    	ti.id("1");
//    	ti.iterations("1");
//    	ti.fieldValue("status", "Passed");
//    	return ti;
//    	
//    }
    
    public Test createTest(int index) throws Exception{
    	String folderName = com.testingfly.automation.core.data.Config.getProp("API_Name");
    	String parentId = getFolderId("test-folders",folderName);
    	if(parentId==null){
    	...
    	t.user_template_xx("user-template-03","N/A");
    	t.user_template_xx("user-template-04","MAN-General");
    	t.user_template_xx("user-template-05","Regression");
    	t.user_template_xx("user-template-06","6-Auto Regression");
    	t.user_template_xx("user-template-17","TechQA-Project");
    	t.parentId(parentId);
    ...
    public TestSet createTestSet(int i) throws Exception{
    	...
    	t.name(allTestMap.get(i).get("testSet")+"-"+com.testingfly.automation.core.data.Config.getProp("Environment"));
    	t.parentId(parentId);
    	t.subtype_id("hp.qc.test-set.external");
    	t.user_template_xx("user-template-01","3-QA");
    	t.user_template_xx("user-template-02","N/A");
    	t.user_template_xx("user-template-03","TechQA-Project");
    	t.user_template_xx("user-template-04","6-Auto Regression");

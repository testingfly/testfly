...
import com.testingfly.automation.alm.Config;
...
public class XmlParser  {
	...
	public static void loadXMLs() throws Exception {
		String folderPath = "test-output/"+com.testingfly.automation.core.data.Config.getProp("API_Name");
	...
	public static HashMap <String, String> parseXML(String fileName) {
		...
		testSet = com.testingfly.automation.core.data.Config.getProp("API_Name");
		...
		testMap.put("testName", testName);
		testMap.put("testSet", testSet);
		testMap.put("hostName", hostName);
		testMap.put("execTime", execTime);
		testMap.put("status", status);
		testMap.put("testDesc", testDesc);
